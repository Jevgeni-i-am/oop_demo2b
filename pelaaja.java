...
/**
    ...
    public void lisaaMaali(String nimi, int maalit){
        this.nimi=nimi;
        this.maalit=maalit;
        maalit++;
    }
     ...
     */
    public void lisaaSyotto(String nimi, int syotot){
        this.nimi=nimi;
        this.syotot=syotot;
        syotot++;
    }
    ...
    public void tulostaTilanne() {
        System.out.println(pelinumero+". "+nimi+" ("+maalit+" + "+syotot+" = "+getPisteet());
    }
